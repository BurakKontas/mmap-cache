...
public class CacheLockedFilesTests {
    ...
    void cleanupOldVersion_handlesLockedFileDeletes() throws Exception {
        ...
        CacheVersion<String> v = new CacheVersion<>(versionDir, shards, Map.of(), TestHelpers.simpleDefinition("locked", 0));
        ...
        // should not throw even if deletion of locked file fails
        cleanup.invoke(mgr, "c1", v);
    }
}
